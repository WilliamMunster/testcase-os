...
| 6 | 人工审核 | 默认 `review: pending`；prompt 中明确免审则 `review: approved` |
...
- [ ] 目录结构搭建 + setup.sh
- [ ] 用例卡片模板 + ID 规范
- [ ] case-design skill（PRD → 用例，含对标 + 审核字段）
